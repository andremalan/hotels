...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create hotels-cf4d
  fly apps create hotels-cf4d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app hotels-cf4d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app hotels-cf4d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'hotels-cf4d-staging' does not match app name in config file 'hotels-cf4d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name hotels-cf4d-db
  fly postgres attach --app hotels-cf4d hotels-cf4d-db

  fly postgres create --name hotels-cf4d-staging-db
  fly postgres attach --app hotels-cf4d-staging hotels-cf4d-staging-db
  ```
